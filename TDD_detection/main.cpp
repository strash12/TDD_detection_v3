...
protected:
	...
	virtual tch::FullTusurCommonConfig handle_configure() override {
		try
		{
			...
			tch::write_common(msg);
			int final_shift = first_part._param.fs/100-first_part._param.fs/1000-(first_part._param.fftsize+first_part._param.cp)-first_part._param.half*first_part._param.shift_band;
